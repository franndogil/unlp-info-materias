...
while (persona.getNombre() != "ZZZ"){
    ...
    // Mostrar el funcionamiento de esMayorQue

    Persona pers1 = new Persona("Franco", 32323, 23);
    Persona pers2 = new Persona("Juampo", 32323, 21);

    Console.WriteLine(pers1.esMayorQue(pers2));